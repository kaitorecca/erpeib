...
erpnext.LeadController = frappe.ui.form.Controller.extend({
	...
	refresh: function() {
		...
		if(!doc.__islocal && doc.__onload && !doc.__onload.is_customer) {
			...
			this.frm.add_custom_button(__("Transaction Management"), this.create_transaction_management, __("Make"));
			this.frm.add_custom_button(__("Call Report"), this.create_call_report, __("Make"));			
	...
	create_transaction_management: function() {
		frappe.model.open_mapped_doc({
			method: "erpnext.crm.doctype.lead.lead.make_transaction_management",
			frm: cur_frm
		})
	},

	create_call_report: function() {
		frappe.model.open_mapped_doc({
			method: "erpnext.crm.doctype.lead.lead.make_call_report",
			frm: cur_frm
		})
	},
