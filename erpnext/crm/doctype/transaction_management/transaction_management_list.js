...
frappe.listview_settings['Transaction Management'] = {
	...
	refresh: function(me) {
		// override assigned to me by owner
		 ...
		 me.page.add_extra_sidebar();

		// add assigned by me
		me.page.add_extra_sidebar_item(__("All Transaction"), function() {
			cur_list.filter_list.clear_filters();
			me.run();
		}, ".stat-label");

		me.page.add_extra_sidebar_item(__("Closing Next Month"), function() {
			cur_list.filter_list.clear_filters();
		...
		me.page.add_extra_sidebar_item(__("Closing This Month"), function() {
			cur_list.filter_list.clear_filters()
		...
		me.page.add_extra_sidebar_item(__("My Transaction"), function() {
			cur_list.filter_list.clear_filters();
			me.filter_list.add_filter(me.doctype, "owner", '=', frappe.session.user);
			me.run();
		}, ".stat-label");

		me.page.add_extra_sidebar_item(__("New in last 7 days"), function() {
			cur_list.filter_list.clear_filters();
		...
		me.page.add_extra_sidebar_item(__("Won"), function() {
			cur_list.filter_list.clear_filters();
